            ...
            <div>
                ...
                <div className="intro-resume-builder">
                    ...
                    <div className="intro-resume-builder-img">
                        <img src={require('./wireframe2.svg')} className="wireframe-img" alt="wireframe"/>
                    </div>
